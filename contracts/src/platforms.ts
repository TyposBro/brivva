...
export const PLATFORM_CATALOG = [
  ...
  { id: "grip", label: "Grip", region: "Korea", auto: true, defaultRtmp: "rtmps://live.grip.fans:443/live/", help: "Auto-connected via Grip Seller API. Paste creds manually if the API is unavailable.", settingsUrl: "https://seller.grip.show/", keyOnly: false },
