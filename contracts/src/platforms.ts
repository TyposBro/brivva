...
export const PLATFORM_CATALOG = [
  ...
  { id: "grip", label: "Grip", region: "Korea", auto: true, defaultRtmp: "", help: "Grip runs on AWS IVS — each broadcast gets a unique RTMPS URL (rtmps://<id>.global-contribute.live-video.net:443/app). Create a broadcast in Grip Business Center → 방송 관리 → 방송 목록 → PC 송출, then paste BOTH server URL and stream key here. Must push within 1h of saving.", settingsUrl: "https://seller.grip.show/", keyOnly: false },
